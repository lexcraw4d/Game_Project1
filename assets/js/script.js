...
let genreVal = document.getElementById("genres");
let consoleVal = document.getElementById("console");
let ratingVal = document.getElementById("rating");
let releaseVal = document.getElementById("release");

// array of selected values 
let combinedValues = [genreVal, consoleVal, ratingVal,  releaseVal]
let result = combinedValues.options[combinedValues.selectedIndex].value;

let userFavorites = document.querySelector("favorite-list");
const containerEL = document.querySelector("container-element");

let savedGames = [];

let savedFavorites = function() {
  localStorage.setItem("", JSON.stringify(combinedValues));
};